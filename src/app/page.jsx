    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      {serviceImages.map((image, index) => (
        <CardContainer key={index} className="inter-var">
          <CardBody className="relative group/card bg-white shadow-lg rounded-md p-6 transform transition-all duration-300 hover:scale-105">
...
<section className="py-16 bg-orange-500 text-white">
  <div className="container mx-auto text-center">
    ...
    <div className="flex flex-col sm:flex-row gap-8 justify-center">
      {[
        { title: "Easy to Use", description: "No coding skills required to automate tasks." },
        { title: "Scalable Solutions", description: "Handle tasks of any complexity effortlessly." },
        { title: "24/7 Support", description: "We’re here to assist you every step of the way." },
      ].map((feature, index) => (
        <div
          key={index}
...
<section id="pricing" className="py-16 bg-white">
  <div className="container mx-auto text-center">
    <h2 className="text-3xl font-bold text-gray-800 mb-8">Our Pricing Plans</h2>
    <p className="text-lg text-gray-600 mb-12">
      Choose a plan that fits your needs. No hidden fees. Pay only for what you use.
    </p>
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      {/* Plan 1 */}
      <div className="bg-gray-50  p-8 ">
        ...
        <ul className="text-left text-gray-600 mb-6">
          <li><span className="mr-2">✔</span> 5 Automation Tasks</li>
    <li><span className="mr-2">✔</span>Basic Reporting</li>
    <li><span className="mr-2">✔</span> Email Support</li>
    <li><span className="mr-2">✔</span> 1 User</li>
        </ul>
        <Button
  ...
  <ul className="text-left text-gray-600 mb-6">
    <li><span className="mr-2">✔</span> 20 Automation Tasks</li>
    <li><span className="mr-2">✔</span> Advanced Reporting</li>
    <li><span className="mr-2">✔</span> Priority Support</li>
    <li><span className="mr-2">✔</span> Up to 5 Users</li>
  </ul>
  <Button
    onClick={() => router.push("/auth/signup")}
    variant="default"
  ...
  >
    Get Started
      ...
      {/* Plan 3 */}
      <div className="bg-gray-50 shadow-xl rounded-md p-8 ">
        <h3 className="text-2xl font-semibold text-gray-800 mb-4">Enterprise Plan</h3>
        <p className="text-xl font-bold text-gray-900 mb-4">$99/month</p>
        <ul className="text-left text-gray-600 mb-6">
          <li><span className="mr-2">✔</span>Unlimited Automation Tasks</li>
    <li><span className="mr-2">✔</span> Full Reporting Suite</li>
    <li><span className="mr-2">✔</span> 24/7 Support</li>
    <li><span className="mr-2">✔</span> Unlimited Users</li>
        </ul>
        <Button
          onClick={() => router.push("/auth/signup")}
          variant="default"
  ...
  <div className="container mx-auto text-center">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
      ...
      <div className="">
        ...
        <p className="text-lg">Operating Hours: 9 AM - 6 PM (Mon - Fri)</p>
      </div>
